...
impl AttributeType {
    pub const fn stringify(val: CK_ATTRIBUTE_TYPE) -> &'static str {
        match val {
            CKA_CLASS => stringify!(CKA_CLASS),
            CKA_TOKEN => stringify!(CKA_TOKEN),
            CKA_PRIVATE => stringify!(CKA_PRIVATE),
            CKA_LABEL => stringify!(CKA_LABEL),
            CKA_APPLICATION => stringify!(CKA_APPLICATION),
            CKA_VALUE => stringify!(CKA_VALUE),
            CKA_OBJECT_ID => stringify!(CKA_OBJECT_ID),
            CKA_CERTIFICATE_TYPE => stringify!(CKA_CERTIFICATE_TYPE),
            CKA_ISSUER => stringify!(CKA_ISSUER),
            CKA_SERIAL_NUMBER => stringify!(CKA_SERIAL_NUMBER),
            CKA_AC_ISSUER => stringify!(CKA_AC_ISSUER),
            CKA_OWNER => stringify!(CKA_OWNER),
            CKA_ATTR_TYPES => stringify!(CKA_ATTR_TYPES),
            CKA_TRUSTED => stringify!(CKA_TRUSTED),
            CKA_CERTIFICATE_CATEGORY => stringify!(CKA_CERTIFICATE_CATEGORY),
            CKA_JAVA_MIDP_SECURITY_DOMAIN => {
                stringify!(CKA_JAVA_MIDP_SECURITY_DOMAIN)
            }
            CKA_URL => stringify!(CKA_URL),
            CKA_HASH_OF_SUBJECT_PUBLIC_KEY => {
                stringify!(CKA_HASH_OF_SUBJECT_PUBLIC_KEY)
            }
            CKA_HASH_OF_ISSUER_PUBLIC_KEY => {
                stringify!(CKA_HASH_OF_ISSUER_PUBLIC_KEY)
            }
            CKA_NAME_HASH_ALGORITHM => stringify!(CKA_NAME_HASH_ALGORITHM),
            CKA_CHECK_VALUE => stringify!(CKA_CHECK_VALUE),
            CKA_KEY_TYPE => stringify!(CKA_KEY_TYPE),
            CKA_SUBJECT => stringify!(CKA_SUBJECT),
            CKA_ID => stringify!(CKA_ID),
            CKA_SENSITIVE => stringify!(CKA_SENSITIVE),
            CKA_ENCRYPT => stringify!(CKA_ENCRYPT),
            CKA_DECRYPT => stringify!(CKA_DECRYPT),
            CKA_WRAP => stringify!(CKA_WRAP),
            CKA_UNWRAP => stringify!(CKA_UNWRAP),
            CKA_SIGN => stringify!(CKA_SIGN),
            CKA_SIGN_RECOVER => stringify!(CKA_SIGN_RECOVER),
            CKA_VERIFY => stringify!(CKA_VERIFY),
            CKA_VERIFY_RECOVER => stringify!(CKA_VERIFY_RECOVER),
            CKA_DERIVE => stringify!(CKA_DERIVE),
            CKA_START_DATE => stringify!(CKA_START_DATE),
            CKA_END_DATE => stringify!(CKA_END_DATE),
            CKA_MODULUS => stringify!(CKA_MODULUS),
            CKA_MODULUS_BITS => stringify!(CKA_MODULUS_BITS),
            CKA_PUBLIC_EXPONENT => stringify!(CKA_PUBLIC_EXPONENT),
            CKA_PRIVATE_EXPONENT => stringify!(CKA_PRIVATE_EXPONENT),
            CKA_PRIME_1 => stringify!(CKA_PRIME_1),
            CKA_PRIME_2 => stringify!(CKA_PRIME_2),
            CKA_EXPONENT_1 => stringify!(CKA_EXPONENT_1),
            CKA_EXPONENT_2 => stringify!(CKA_EXPONENT_2),
            CKA_COEFFICIENT => stringify!(CKA_COEFFICIENT),
            CKA_PUBLIC_KEY_INFO => stringify!(CKA_PUBLIC_KEY_INFO),
            CKA_PRIME => stringify!(CKA_PRIME),
            CKA_SUBPRIME => stringify!(CKA_SUBPRIME),
            CKA_BASE => stringify!(CKA_BASE),
            CKA_PRIME_BITS => stringify!(CKA_PRIME_BITS),
            CKA_SUB_PRIME_BITS => stringify!(CKA_SUB_PRIME_BITS),
            CKA_VALUE_BITS => stringify!(CKA_VALUE_BITS),
            CKA_VALUE_LEN => stringify!(CKA_VALUE_LEN),
            CKA_EXTRACTABLE => stringify!(CKA_EXTRACTABLE),
            CKA_LOCAL => stringify!(CKA_LOCAL),
            CKA_NEVER_EXTRACTABLE => stringify!(CKA_NEVER_EXTRACTABLE),
            CKA_ALWAYS_SENSITIVE => stringify!(CKA_ALWAYS_SENSITIVE),
            CKA_KEY_GEN_MECHANISM => stringify!(CKA_KEY_GEN_MECHANISM),
            CKA_MODIFIABLE => stringify!(CKA_MODIFIABLE),
            CKA_COPYABLE => stringify!(CKA_COPYABLE),
            CKA_DESTROYABLE => stringify!(CKA_DESTROYABLE),
            CKA_EC_PARAMS => stringify!(CKA_EC_PARAMS),
            CKA_EC_POINT => stringify!(CKA_EC_POINT),
            CKA_SECONDARY_AUTH => stringify!(CKA_SECONDARY_AUTH),
            CKA_AUTH_PIN_FLAGS => stringify!(CKA_AUTH_PIN_FLAGS),
            CKA_ALWAYS_AUTHENTICATE => stringify!(CKA_ALWAYS_AUTHENTICATE),
            CKA_WRAP_WITH_TRUSTED => stringify!(CKA_WRAP_WITH_TRUSTED),
            CKA_OTP_FORMAT => stringify!(CKA_OTP_FORMAT),
            CKA_OTP_LENGTH => stringify!(CKA_OTP_LENGTH),
            CKA_OTP_TIME_INTERVAL => stringify!(CKA_OTP_TIME_INTERVAL),
            CKA_OTP_USER_FRIENDLY_MODE => stringify!(CKA_OTP_USER_FRIENDLY_MODE),
            CKA_OTP_CHALLENGE_REQUIREMENT => {
                stringify!(CKA_OTP_CHALLENGE_REQUIREMENT)
            }
            CKA_OTP_TIME_REQUIREMENT => stringify!(CKA_OTP_TIME_REQUIREMENT),
            CKA_OTP_COUNTER_REQUIREMENT => stringify!(CKA_OTP_COUNTER_REQUIREMENT),
            CKA_OTP_PIN_REQUIREMENT => stringify!(CKA_OTP_PIN_REQUIREMENT),
            CKA_OTP_USER_IDENTIFIER => stringify!(CKA_OTP_USER_IDENTIFIER),
            CKA_OTP_SERVICE_IDENTIFIER => stringify!(CKA_OTP_SERVICE_IDENTIFIER),
            CKA_OTP_SERVICE_LOGO => stringify!(CKA_OTP_SERVICE_LOGO),
            CKA_OTP_SERVICE_LOGO_TYPE => stringify!(CKA_OTP_SERVICE_LOGO_TYPE),
            CKA_OTP_COUNTER => stringify!(CKA_OTP_COUNTER),
            CKA_OTP_TIME => stringify!(CKA_OTP_TIME),
            CKA_GOSTR3410_PARAMS => stringify!(CKA_GOSTR3410_PARAMS),
            CKA_GOSTR3411_PARAMS => stringify!(CKA_GOSTR3411_PARAMS),
            CKA_GOST28147_PARAMS => stringify!(CKA_GOST28147_PARAMS),
            CKA_HW_FEATURE_TYPE => stringify!(CKA_HW_FEATURE_TYPE),
            CKA_RESET_ON_INIT => stringify!(CKA_RESET_ON_INIT),
            CKA_HAS_RESET => stringify!(CKA_HAS_RESET),
            CKA_PIXEL_X => stringify!(CKA_PIXEL_X),
            CKA_PIXEL_Y => stringify!(CKA_PIXEL_Y),
            CKA_RESOLUTION => stringify!(CKA_RESOLUTION),
            CKA_CHAR_ROWS => stringify!(CKA_CHAR_ROWS),
            CKA_CHAR_COLUMNS => stringify!(CKA_CHAR_COLUMNS),
            CKA_COLOR => stringify!(CKA_COLOR),
            CKA_BITS_PER_PIXEL => stringify!(CKA_BITS_PER_PIXEL),
            CKA_CHAR_SETS => stringify!(CKA_CHAR_SETS),
            CKA_ENCODING_METHODS => stringify!(CKA_ENCODING_METHODS),
            CKA_MIME_TYPES => stringify!(CKA_MIME_TYPES),
            CKA_MECHANISM_TYPE => stringify!(CKA_MECHANISM_TYPE),
            CKA_REQUIRED_CMS_ATTRIBUTES => stringify!(CKA_REQUIRED_CMS_ATTRIBUTES),
            CKA_DEFAULT_CMS_ATTRIBUTES => stringify!(CKA_DEFAULT_CMS_ATTRIBUTES),
            CKA_SUPPORTED_CMS_ATTRIBUTES => stringify!(CKA_SUPPORTED_CMS_ATTRIBUTES),
            CKA_WRAP_TEMPLATE => stringify!(CKA_WRAP_TEMPLATE),
            CKA_UNWRAP_TEMPLATE => stringify!(CKA_UNWRAP_TEMPLATE),
            CKA_DERIVE_TEMPLATE => stringify!(CKA_DERIVE_TEMPLATE),
            CKA_ALLOWED_MECHANISMS => stringify!(CKA_ALLOWED_MECHANISMS),
            _ => panic!("unknown AttributeType"),
        }
    }
}
